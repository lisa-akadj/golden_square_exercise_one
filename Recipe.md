...
"""
Given a certain text ()
It returns a the number of words in the text ()
"""
def test_length_of_text():
    result = integer showing number of words #(is this redundant?) 

"""
Given a text with less than 200 words 
Return seconds it will take to read e.g. 10 sec. with one decimal place
"""
def test_less_than_two_hundred_words() 
result = reading_time("This sentence is less than two hundred words.")  => "60 seoconds to read 200 words. (60/200)*8 = 2.4 sec"



"""
Given a text longer than 200 words (the example has 254 words) 
Returns the length of time it takes to read in minutes and seconds. e.g. 1 min a few seconds (calculate no. of seconds later) 
"""
...
result = reading_time("") => 0 min 0.0 sec
